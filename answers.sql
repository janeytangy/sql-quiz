...
SELECT common_name Aon_name, price FROM melons WHERE melon_type='Watermelon' AND price > 5;
...
SELECT melon_type, common_name, price AS USD, price*.73 AS EUR FROM melons;
